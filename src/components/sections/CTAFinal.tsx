...
export function CTAFinal() {
  return (
    ...
    >
      <Doodle name="sol" className="-top-4 -right-4 h-24 w-24 text-brincando-laranja/35 sm:h-36 sm:w-36" />
      <Doodle name="folha" className="bottom-4 left-2 h-16 w-12 text-brincando-salvia/40 sm:h-20 sm:w-16" />
      <Doodle name="estrela" className="top-10 left-4 h-8 w-8 text-brincando-rosa/50 sm:left-16 sm:h-10 sm:w-10" />
