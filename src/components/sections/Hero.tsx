  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 container-page pb-[max(5.25rem,calc(env(safe-area-inset-bottom)+4.25rem))] pt-[8.5rem] sm:pt-0 sm:pb-20">
        ...
        >
          <h1 className="!text-brincando-terra-escuro text-[2.15rem] leading-[1.15] [text-shadow:0_2px_16px_var(--brincando-creme),0_0_36px_var(--brincando-creme)] sm:text-5xl lg:text-[3.4rem]">
